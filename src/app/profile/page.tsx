          ...
          <main className="flex-1 min-w-0 flex flex-col gap-8 pb-12">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between p-6 rounded-xl bg-white dark:bg-[#192433] border border-slate-200 dark:border-input-border shadow-sm">
              <div className="flex gap-5 items-center">
                <div className="h-24 w-24 rounded-full bg-linear-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white text-3xl font-bold border-2 border-slate-200 dark:border-input-border shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-end gap-4 pt-4 border-t border-slate-200 dark:border-input-border">
              <button
                ...
                disabled={isSaving}
                className="px-6 py-3 rounded-lg text-slate-700 dark:text-white hover:bg-slate-100 dark:hover:bg-input-border transition-colors w-full sm:w-auto disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed font-medium"
              >
                Discard Changes
              </button>
              <button
                onClick={handleSave}
                disabled={isSaving}
                className="px-8 py-3 rounded-lg bg-blue-600 hover:bg-blue-700 dark:bg-primary dark:hover:bg-blue-600 text-white font-bold shadow-lg shadow-blue-600/20 dark:shadow-blue-500/20 transition-all w-full sm:w-auto flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
              >
                {isSaving ? (
                  <>
