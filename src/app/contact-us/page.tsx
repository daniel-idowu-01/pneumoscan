...
<h1 className="text-slate-900 dark:text-white text-4xl md:text-5xl font-black leading-tight tracking-[-0.033em]">Contact Support</h1>
<p className="text-slate-500 dark:text-text-secondary text-lg font-normal leading-normal max-w-2xl">
                        Our medical support team is available 24/7 to assist with imaging processing, API integrations, and technical inquiries.
                    </p>
</div>
...
<span className="text-slate-900 dark:text-white text-sm font-medium leading-normal pb-2">Full Name</span>
<input className="form-input w-full rounded-lg text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-[#111822] h-12 px-4 placeholder:text-slate-400 dark:placeholder:text-text-secondary focus:border-primary focus:ring-1 focus:ring-primary transition-colors outline-none" placeholder="Dr. Jane Doe" type="text"/>
</label>
<label className="flex flex-col flex-1">
<span className="text-slate-900 dark:text-white text-sm font-medium leading-normal pb-2">Medical License ID <span className="text-slate-400 font-normal">(Optional)</span></span>
<input className="form-input w-full rounded-lg text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-[#111822] h-12 px-4 placeholder:text-slate-400 dark:placeholder:text-text-secondary focus:border-primary focus:ring-1 focus:ring-primary transition-colors outline-none" placeholder="MD-12345-XY" type="text"/>
</label>
</div>
<div className="flex flex-col md:flex-row gap-6">
<label className="flex flex-col flex-1">
<span className="text-slate-900 dark:text-white text-sm font-medium leading-normal pb-2">Work Email</span>
<input className="form-input w-full rounded-lg text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-[#111822] h-12 px-4 placeholder:text-slate-400 dark:placeholder:text-text-secondary focus:border-primary focus:ring-1 focus:ring-primary transition-colors outline-none" placeholder="jane.doe@hospital.org" type="email"/>
</label>
<label className="flex flex-col flex-1">
<span className="text-slate-900 dark:text-white text-sm font-medium leading-normal pb-2">Topic</span>
...
<option disabled={false} selected={true} value="">Select a topic</option>
...
<label className="flex flex-col flex-1">
<span className="text-slate-900 dark:text-white text-sm font-medium leading-normal pb-2">Message</span>
<textarea className="form-textarea w-full rounded-lg text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-[#111822] min-h-[160px] p-4 placeholder:text-slate-400 dark:placeholder:text-text-secondary focus:border-primary focus:ring-1 focus:ring-primary transition-colors resize-y outline-none" placeholder="Describe your issue or question regarding x-ray processing..."></textarea>
</label>
...
<button className="flex items-center justify-center rounded-lg bg-primary hover:bg-blue-600 text-white font-bold h-12 px-8 transition-colors" type="button">
                                        Send Message
                                    </button>
</div>
</form>
...
<p className="text-slate-500 dark:text-text-secondary text-sm mt-1 mb-2">Typically replies within 2 hours.</p>
...
<p className="text-slate-500 dark:text-text-secondary text-sm mt-1 mb-2">Mon-Fri, 9am - 6pm EST.</p>
...
<p className="mt-2 text-sm text-slate-500 dark:text-text-secondary leading-relaxed">
                                        We support DICOM (.dcm), JPEG, and PNG formats. For best diagnostic results, we recommend high-resolution DICOM files directly from your imaging equipment.
                                    </p>
</details>
<details className="group py-4">
<summary className="flex cursor-pointer items-center justify-between font-medium text-slate-900 dark:text-white">
...
<p className="mt-2 text-sm text-slate-500 dark:text-text-secondary leading-relaxed">
                                        Yes. Our pre-processing pipeline automatically scrubs PII (Personally Identifiable Information) from metadata before any analysis begins, ensuring full HIPAA compliance.
                                    </p>
</details>
<details className="group py-4">
<summary className="flex cursor-pointer items-center justify-between font-medium text-slate-900 dark:text-white">
...
<p className="mt-2 text-sm text-slate-500 dark:text-text-secondary leading-relaxed">
                                        Typical processing time for a standard chest X-ray is under 30 seconds. Batch uploads may take longer depending on server load and file size.
                                    </p>
</details>
</div>
<div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
<a className="inline-flex items-center gap-2 text-sm font-semibold text-primary hover:text-blue-500" href="#">
...
<img className="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-50" data-alt="Abstract medical technology background with blue overlay" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBNe3NVQp1cHI-FNPrygRErFwDeeaEpojRsLjZJ4OQ-jy6RiFobebLtKYdPgJfIdG6MLcOM53nc6nFA3T0aqDpp3WvAaw86wcSgA1i4nCy_zWBtTZsTe5WzB9F2LxNARTChLKgye_1qmoV60OyTb_k21WvJFihSwT-61YbMMuIFXYGlqsPu0pQ_3hBk4bttNypb9BY93_S8E5mr3203VkAl1PJ0FPFiBqGjPOz-T13qxgembg84dhO29EcjT9xY0oaPNPuOeg86K6Uy"/>
