                  ...
                  <tr className="bg-[#192433] border-b border-border-dark">
                    <th className="p-5 text-xs font-semibold tracking-wider text-text-secondary uppercase w-[250px] cursor-pointer hover:text-white group">
                      <div className="flex items-center gap-1">
                        Upload Date
                        <span className="material-symbols-outlined text-[16px] text-primary opacity-100">
                          arrow_downward
                        </span>
                      </div>
                    </th>
                    <th className="p-5 text-xs font-semibold tracking-wider text-text-secondary uppercase w-[150px]">
                      Patient ID
                    </th>
                    <th className="p-5 text-xs font-semibold tracking-wider text-text-secondary uppercase">
                      Preview
                    </th>
                    <th className="p-5 text-xs font-semibold tracking-wider text-text-secondary uppercase">
                      AI Analysis
                    ...
                    <th className="p-5 text-xs font-semibold tracking-wider text-text-secondary uppercase text-right">
                      Actions
                    </th>
                  </tr>
                </thead>
