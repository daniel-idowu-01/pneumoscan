      ...
      <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden">
        <div className="layout-container flex h-full grow flex-col">
              ...
              <div className="@container">
                <div className="flex flex-col gap-6 py-10 @[480px]:gap-8 @[864px]:flex-row items-center px-10">
                  <div className="flex flex-col gap-6 @[480px]:min-w-[400px] @[480px]:gap-8 @[864px]:justify-center flex-1">
                    <div className="flex flex-col gap-2 text-left">
                      ...
                      <h2 className="text-slate-400 text-lg font-normal leading-relaxed">
                        Bridging the gap between cutting-edge deep learning and clinical excellence
                  ...
                  <div
                    ...
                    data-alt="Abstract visualization of a glowing blue neural network overlaying a human chest x-ray"
                    style={{
                      backgroundImage:
                        "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCxQcmjf_vr7jtOQkCPQ71FiRwGR_lM68u3EyDb2fXrWQ7E127ED1Y6rioSZMWpnpaKzTaFZx7x6cuA4AGMq0H4wIkNuyzG48khZyUbixwFa5t1PaiOnjtQb6mhUhlttTJuVWWzUSsBIysCq2JrJLzuM3hj6vfEOtf1AASuE3wR5AX6Wecjd3VzKAm9omKEj14VS_FqhjXpqK-unVrJCT_ksEBezXnHLRvwspPrMz1F4KP69iILbN2Pld02XKiRlYerek4RhmAfCM9F')",
                    }}
                  >
              ...
              <div className="flex flex-col gap-10">
                <div className="flex flex-col gap-4 text-center items-center">
                  ...
                  <p className="text-slate-400 text-base font-normal leading-relaxed max-w-[600px]">
                    We are dedicated to supporting medical professionals with tools that enhance
                    accuracy and efficiency, removing the noise so experts can focus on the signal.
                  </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="flex flex-1 gap-4 rounded-xl border border-border-light bg-surface-dark p-6 flex-col hover:border-primary/50 transition-colors group">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-text-muted text-sm font-normal leading-relaxed">
                        Our models are trained on over 1 million verified datasets to ensure
                        precision that rivals top specialists.
                      </p>
                    </div>
                  </div>
                  <div className="flex flex-1 gap-4 rounded-xl border border-border-light bg-surface-dark p-6 flex-col hover:border-primary/50 transition-colors group">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-text-muted text-sm font-normal leading-relaxed">
                        Get results in seconds, allowing for faster triage and decision making in
                  ...
                  <div className="flex flex-1 gap-4 rounded-xl border border-border-light bg-surface-dark p-6 flex-col hover:border-primary/50 transition-colors group">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-text-muted text-sm font-normal leading-relaxed">
                        Built with HIPAA compliance at the core to ensure patient data is never
                        compromised or mishandled.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-row justify-between items-end">
                  <div className="flex flex-col gap-2">
                    ...
                    <p className="text-slate-400">
                      The medical and technical minds behind MedScan AI.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                  <div className="flex flex-col gap-3 group">
                    <div
                      ...
                      data-alt="Portrait of Dr. Sarah Chen, Chief Medical Officer, wearing a white coat"
                      style={{
                        backgroundImage:
                          "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAXhaHQ3nh2oQokdeaCElVqpBwoTVvuUQHoJ8Wp2CvCdhz6kUwN-RuW3OnEfC-fiLD8JIW2X47PIUuQLvqqRpb3kPWx5y5fXJMv-IATxVQrGvAkPhsT66qYFELwq_zxQzj-VNbES8VOzIsUGXA-SXQg5dcr3l2_DZtnlPqV3KqLFmSZnBKF1nIm9ehDxwxtgBRaSIH3I9Rr1WXNvpnY5kJrS0yrYKKgykmyKO2rlIIp15jDyH9H9dygEjO36GVnBcDuY4agPLCV_2uo')",
                      }}
                    ></div>
                    <div>
                  ...
                  <div className="flex flex-col gap-3 group">
                    <div
                      className="w-full aspect-[4/5] rounded-xl bg-cover bg-center overflow-hidden border border-border-light grayscale group-hover:grayscale-0 transition-all duration-300"
                      data-alt="Portrait of Dr. Emily Rodriguez, Clinical Director, smiling"
                      style={{
                        backgroundImage:
                          "url('https://lh3.googleusercontent.com/aida-public/AB6AXuB1oJEsJOrF7yyMgjPRq_L4Nop3rE4SWqK4GxmIfkWA192bMtsIQ4fxxhlunb6s9DiKb3te7MuHExzTuhon6GSE0OtYEY8z4ajzVV4_Ug3-NDJHltR75ziD5adOCLI_omlJ_sKqgbu5UIBujoOXYUWoRpyPvFclSBJy1Q2DTJ_VPCqtgiWLB3OD5VhwEh1_0etLJgyBzFfO3x8SpxNCEO9XErcsQ5hLcHvxbA61KhLqepj01ETnM0SZBEQfVbVRxayu6mIif6KkG3vw')",
                      }}
                    ></div>
                    <div>
          ...
          <div className="w-full flex justify-center py-20 px-4 md:px-10 lg:px-40">
            <div className="layout-content-container flex flex-col flex-1">
              <h2 className="text-white text-2xl font-bold leading-tight mb-8 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-surface-dark border border-border-light p-8 rounded-xl relative">
                  ...
                  <p className="text-slate-300 text-lg leading-relaxed mb-6 italic relative z-10">
                    "MedScan AI has become an indispensable second pair of eyes in our clinic. The
                    speed at which we can now triage critical cases has improved our patient
                    outcomes significantly."
                  </p>
                  <div className="flex items-center gap-4">
                    <div
                      className="size-12 rounded-full bg-cover bg-center"
                      data-alt="Portrait of Dr. A. Smith"
                      style={{
                        backgroundImage:
                          "url('https://lh3.googleusercontent.com/aida-public/AB6AXuB62mkZqDE4fMmntbHYiZHDpQ4ClPvJVDr5ra2WL31ESsKRD5zKTICvIbQ_FngmKgdOIhMygSWobytYlT53ulx8_sNMZRMKunKXAZoKL-54gx013VzbjtzqyRneuMd84-RaOtB6eYIb-WAiZVIPorAdMgNFBWgnebBcQvMcRb3yCb8YtcCNYQVhDy_0BoLqCPDxqaV8OyiEMJcZEdcp5v0_4Fbi8kS7mscp4KUGWlp3RxU8_eKMIyEGWT8TFgoFiFsnwWUYgNFWI4Uv')",
                      }}
                    ></div>
                    <div>
                ...
                <div className="bg-surface-dark border border-border-light p-8 rounded-xl relative">
                  ...
                  <p className="text-slate-300 text-lg leading-relaxed mb-6 italic relative z-10">
                    "The integration was seamless. Unlike other tools that disrupt our workflow,
                    MedScan fits right into our PACS system and provides value from day one."
                  </p>
                  <div className="flex items-center gap-4">
                    <div
                      className="size-12 rounded-full bg-cover bg-center"
                      data-alt="Portrait of Dr. L. Ray"
                      style={{
                        backgroundImage:
                          "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDN6eFa1I0ljPt_TA9ETg_Lwmtnfur1Wv-CYa956xHc-K0xIHimyiE03TWpcH2Y_WiRdYxNVGrc5BZAHQ9R1IhBEl7T9cfRjWIWwwrtPsXHxmMxaXnRy1Nnf42PDDJjVkR2CYfSLYeZE6ohzKm4rIcfpRMlITW59vXmOP9-19x2BQKZ75RfmG5YFwvFPcbdQQP2JW5PrwulbUGxY6O9nuuJvSF059udyPL23D13SeQZ0VewFNJaEl4RUW7IWQp9o8eufWthwikxBfve')",
                      }}
                    ></div>
                    <div>
