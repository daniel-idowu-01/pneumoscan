      ...
      <main className="flex-1 w-full max-w-[1440px] mx-auto p-4 lg:p-8 flex flex-col gap-6">
        <section className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-slate-500 dark:text-[#92a9c9] text-base">
        ...
        <section className="bg-surface-light dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-[#233348] p-4 flex flex-col lg:flex-row gap-4 justify-between items-start lg:items-center shadow-sm">
          <div className="w-full lg:w-96">
            <label className="relative flex items-center w-full">
              ...
              <input
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-[#233348] border-none rounded-lg text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-[#6b7c93] focus:ring-2 focus:ring-primary focus:bg-white dark:focus:bg-[#1a2430] transition-all text-sm font-medium"
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1 text-xs font-semibold text-slate-500 dark:text-[#92a9c9] uppercase tracking-wider">
              Filters:
            </div>
            <button className="group flex items-center gap-2 px-3 py-2 bg-slate-50 dark:bg-[#233348] hover:bg-slate-100 dark:hover:bg-[#2d4059] rounded-lg border border-slate-200 dark:border-transparent transition-colors">
              ...
              <span className="material-symbols-outlined text-[18px] text-slate-400 group-hover:text-slate-600 dark:group-hover:text-white transition-colors">
                expand_more
              </span>
            </button>
            <button className="group flex items-center gap-2 px-3 py-2 bg-slate-50 dark:bg-[#233348] hover:bg-slate-100 dark:hover:bg-[#2d4059] rounded-lg border border-slate-200 dark:border-transparent transition-colors">
        ...
        <section className="flex-1 bg-surface-light dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-[#233348] overflow-hidden shadow-sm flex flex-col">
            ...
            <table className="w-full min-w-[1000px] border-collapse">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-[#233348]">
                ...
                <tr className="group hover:bg-slate-50 dark:hover:bg-[#1e2a3b] transition-colors border-none">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="size-8 rounded-full bg-teal-100 dark:bg-teal-900/30 flex items-center justify-center text-teal-600 dark:text-teal-400 text-xs font-bold">
                        SL
                      </div>
                      <div className="flex flex-col">
                        <a
          ...
          <div className="px-6 py-4 border-t border-slate-200 dark:border-[#233348] bg-slate-50 dark:bg-[#111822] flex flex-col sm:flex-row items-center justify-between gap-4">
            <span className="text-sm text-slate-500 dark:text-slate-400">
              Showing <span className="font-medium text-slate-700 dark:text-white">1</span> to{' '}
              <span className="font-medium text-slate-700 dark:text-white">6</span> of{' '}
              <span className="font-medium text-slate-700 dark:text-white">24</span> results
            </span>
            <div className="flex items-center gap-2">
              <button
                className="px-3 py-1.5 text-sm font-medium text-slate-500 dark:text-slate-400 bg-white dark:bg-[#233348] border border-slate-200 dark:border-slate-700 rounded-md hover:bg-slate-50 dark:hover:bg-[#2d4059] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                disabled={false}
              >
                Previous
              </button>
              <button className="px-3 py-1.5 text-sm font-medium text-white bg-primary border border-primary rounded-md hover:bg-primary-hover transition-colors">
                1
              </button>
              <button className="px-3 py-1.5 text-sm font-medium text-slate-700 dark:text-slate-300 bg-white dark:bg-[#233348] border border-slate-200 dark:border-slate-700 rounded-md hover:bg-slate-50 dark:hover:bg-[#2d4059] transition-colors">
                2
              </button>
              <button className="px-3 py-1.5 text-sm font-medium text-slate-700 dark:text-slate-300 bg-white dark:bg-[#233348] border border-slate-200 dark:border-slate-700 rounded-md hover:bg-slate-50 dark:hover:bg-[#2d4059] transition-colors">
                3
