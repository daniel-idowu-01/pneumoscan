        ...
        <section className="flex-1 flex flex-col min-w-0 bg-black relative group/viewer">
          <div className="absolute top-0 left-0 right-0 p-4 z-10 bg-linear-to-b from-black/80 to-transparent flex justify-between items-start pointer-events-none">
            ...
            <div className="pointer-events-auto flex items-center gap-2">
              <div className="flex items-center gap-2 bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-lg border border-white/10">
                ...
                <button
                  aria-checked="true"
                  className="relative inline-flex h-5 w-9 items-center rounded-full bg-primary transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                  role="switch"
                >
          ...
          <div className="flex-1 flex items-center justify-center overflow-hidden relative bg-[#050505]">
            <div
              ...
              style={{
                backgroundImage:
                  'linear-gradient(#333 1px, transparent 1px), linear-gradient(90deg, #333 1px, transparent 1px); background-size: 50px 50px',
              }}
            ></div>
            <Image
              alt="Chest X-Ray scan showing lungs and ribcage with slight opacity in the lower left lung"
              className="max-w-full max-h-full object-contain opacity-90 transition-transform duration-200 scale-100"
              data-alt="Chest X-Ray scan showing lungs and ribcage"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuCgPBxqCWv5Y2yUEifeDr_aGdJ5eEVZxSTZi_rl5-5nzuRRB-kqGNaXYaijLkwy-b4zgYyeKYCmiLcfawxeO8nJgym-BMAomBxJHOObTyDIVbTrdIgt6L010iOPjI4r5jQ8kMW3lgXs-lWd_KTmf3AgLOndrtsoqZ1TcZZoUBW4k_3xMzNMXqsA4tQA5dEbYxoz41F5CP-HbCU4MUx7Ctn90_EC6HdE9P3GIjp_nR_mPYYaqx-ERFVyNSb2aNu8eZ5bDj1o-S50_XxE"
            />
            ...
            <div className="absolute top-[45%] left-[55%] w-24 h-24 border-2 border-primary/50 border-dashed rounded-full pointer-events-none flex items-center justify-center">
              <span className="bg-primary text-white text-[10px] font-bold px-1 rounded absolute -top-3">
                94%
              </span>
            </div>
          </div>
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10">
            <div className="flex items-center gap-1 p-1 bg-surface-dark/90 backdrop-blur-md border border-border-dark rounded-xl shadow-2xl">
              <button
                className="p-2 text-text-secondary hover:text-white hover:bg-white/10 rounded-lg transition-colors tooltip"
                title="Zoom Out"
              >
              ...
              <button
                className="p-2 text-primary bg-primary/10 rounded-lg transition-colors border border-primary/20"
                title="Contrast"
              >
        ...
        <aside className="w-[400px] flex-none bg-white dark:bg-background-dark border-l border-slate-200 dark:border-border-dark flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8">
            <div className="space-y-4">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-text-secondary">
                Patient Information
              </h3>
              <div className="bg-slate-50 dark:bg-surface-dark rounded-xl p-4 border border-slate-200 dark:border-border-dark">
                ...
                <div className="flex justify-between py-2 border-b border-slate-200 dark:border-white/5">
                  ...
                  <span className="text-slate-900 dark:text-white text-sm font-medium font-mono">
                    MRN-8821
                  </span>
                </div>
                <div className="flex justify-between py-2 border-b border-slate-200 dark:border-white/5">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="w-full bg-slate-200 dark:bg-surface-dark rounded-full h-2">
                    <div
                      className="bg-orange-400 h-2 rounded-full opacity-80"
                      style={{ width: '45%' }}
                    ></div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="w-full bg-slate-200 dark:bg-surface-dark rounded-full h-2">
                    <div
                      className="bg-slate-500 h-2 rounded-full opacity-40"
                      style={{ width: '12%' }}
                    ></div>
                  </div>
                </div>
            ...
            <div className="space-y-3">
              <label
                className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-text-secondary"
                htmlFor="notes"
              >
                Radiologist Notes
              </label>
              <textarea
                ...
                id="notes"
                placeholder="Add clinical observations or corrections..."
              ></textarea>
            </div>
          </div>
