  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between p-6 rounded-xl bg-[#192433] border border-input-border">
      <div className="flex gap-5 items-center">
        <div
          className="h-24 w-24 rounded-full bg-cover bg-center border-2 border-input-border shadow-lg"
          style={{
            backgroundImage:
      ...
      <button className="flex items-center gap-2 px-4 py-2.5 bg-input-border hover:bg-[#2d4059] text-white rounded-lg text-sm font-bold">
