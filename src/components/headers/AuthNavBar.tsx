...
const AuthNavBar = () => {
  return (
    <header className="flex items-center justify-between border-b border-gray-200 dark:border-input-border px-6 py-4 md:px-10 bg-white dark:bg-background-dark/80 backdrop-blur-md sticky top-0 z-50">
