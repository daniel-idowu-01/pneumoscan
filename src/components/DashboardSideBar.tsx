...
<div className="bg-center bg-no-repeat bg-cover rounded-full size-12 shrink-0 border-2 border-border-dark" data-alt="Doctor profile picture placeholder" 
style={{backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuB-YGgP6oLg8q5f5fQAHWtspHiYb30f6QDm7giPvm3WL-f6ZGvtBs5cSIn2_7AsRN_NHCcw2sNQZVYy_22LcXmvk2h7PnAuKqJUq0UZGkMZGaqRswjcTpTS-HAC8OBnE-JUFaVlLGwRHznbdGIg4YUt5FUeDLhusOO6ShuSIK5bm26NXdC3PMDTRs9w_Tl4rzbe9JyH4DYZ2s0YQoFDBcCscfEadMa5mdyghphSMgysjHG96XeqWBnMwWn6HZsS79Ehk0OSaQUN_lhr")'}}>
</div>
<div className="flex flex-col overflow-hidden">
<h1 className="text-white text-base font-bold leading-tight truncate">Dr. Sarah Smith</h1>
<p className="text-[#92a9c9] text-xs font-medium leading-normal truncate">Radiology Dept.</p>
</div>
</div>
