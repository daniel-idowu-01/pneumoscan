...
const LandingPage = () => {
    return (
        ...
        <main className="flex flex-1 flex-col items-center">
            <section className="w-full max-w-[1280px] px-6 py-12 lg:px-10 lg:py-20">
            ...
            <p className="text-lg font-normal leading-relaxed text-slate-600 dark:text-slate-400">
                                            Securely upload and analyze chest X-rays in seconds. Supporting radiologists with state-of-the-art deep learning models for faster, more accurate preliminary findings.
                                        </p>
            <div className="flex flex-wrap gap-4 pt-2">
            <button className="flex h-12 min-w-[140px] items-center justify-center rounded-lg bg-primary px-6 text-base font-bold text-white shadow-lg shadow-primary/25 hover:bg-blue-600 hover:scale-[1.02] transition-all">
                                                Create Account
                                            </button>
            <button className="flex h-12 min-w-[140px] items-center justify-center rounded-lg border border-slate-200 bg-white px-6 text-base font-bold text-slate-900 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700 transition-colors">
                                                Learn More
                                            </button>
            </div>
          ...
          <div className="relative min-h-screen">
            <div 
                className="absolute inset-0 bg-cover bg-center va_rnXWJHh3189oHA8of-L_85Jh6whHT5FRHBzw2y1UzTijJMZ5AefocHfMy8FIjWwVz2KrP3G0SYgBQ0zJdus3W5qc-PBZLehfGZZBeXgB0gQR5X1vWompZOsHKvyEU5HNza0jGl5t9YV6OKwfzCXoi_MIQahDx63Zx-v_MNwWtUs6I9zEv-uYB0z6gMCBnHCC1GrmzNatUlhNc2Gll1vWVu4FcEMlimldCWUPVyW79J-XQY_f_KQCBjg01uq13MRd7gMiX)']" 
                aria-label="Futuristic digital interface displaying chest x-ray analysis with blue data overlays"
                style={{backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCBi65eva_rnXWJHh3189oHA8of-L_85Jh6whHT5FRHBzw2y1UzTijJMZ5AefocHfMy8FIjWwVz2KrP3G0SYgBQ0zJdus3W5qc-PBZLehfGZZBeXgB0gQR5X1vWompZOsHKvyEU5HNza0jGl5t9YV6OKwfzCXoi_MIQahDx63Zx-v_MNwWtUs6I9zEv-uYB0z6gMCBnHCC1GrmzNatUlhNc2Gll1vWVu4FcEMlimldCWUPVyW79J-XQY_f_KQCBjg01uq13MRd7gMiX'}"}}
            >
            </div>
            </div> 
            {/* <img
  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCBi65eva_rnXWJHh3189oHA8of-L_85Jh6whHT5FRHBzw2y1UzTijJMZ5AefocHfMy8FIjWwVz2KrP3G0SYgBQ0zJdus3W5qc-PBZLehfGZZBeXgB0gQR5X1vWompZOsHKvyEU5HNza0jGl5t9YV6OKwfzCXoi_MIQahDx63Zx-v_MNwWtUs6I9zEv-uYB0z6gMCBnHCC1GrmzNatUlhNc2Gll1vWVu4FcEMlimldCWUPVyW79J-XQY_f_KQCBjg01uq13MRd7gMiX"
/> */}
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl">
                                        Built for speed, accuracy, and rigorous security standards in clinical environments.
                                    </p>
            </div>
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">HIPAA Compliant Security</h3>
            <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                                                Enterprise-grade AES-256 encryption and full regulatory compliance ensure patient data remains protected at all times.
                                            </p>
            </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">Instant Analysis</h3>
            <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                                                Get preliminary findings in seconds. Our optimized inference engine is designed for high-volume clinical workflows.
                                            </p>
            </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">High Accuracy Models</h3>
            <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                                                Validated against extensive, diverse datasets to minimize false positives and support better clinical decision making.
                                            </p>
            </div>
            </div>
            </div>
            ...
            <div className="mx-auto w-full max-w-[1280px] overflow-hidden rounded-3xl bg-gradient-to-br from-[#1a2636] to-background-dark border border-slate-700 relative">
            ...
            <p className="max-w-xl text-lg text-slate-300">
                                        Join thousands of radiologists using MedAI Analyze to enhance precision and speed.
                                    </p>
