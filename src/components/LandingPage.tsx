            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-16">
              <div className="flex flex-1 flex-col gap-6 lg:max-w-xl">
                ...
                <p className="text-lg font-normal leading-relaxed text-slate-600 dark:text-slate-400">
                  Securely upload and analyze chest X-rays in seconds. Supporting radiologists with
                  state-of-the-art deep learning models for faster, more accurate preliminary
                  findings.
                </p>
                <div className="flex flex-wrap gap-4 pt-2">
                  <Link href="/signup">
                    <button className="flex h-12 min-w-35 items-center justify-center rounded-lg bg-primary px-6 text-base font-bold text-white shadow-lg shadow-primary/25 hover:bg-blue-600 hover:scale-[1.02] transition-all cursor-pointer">
                      Create Account
                    </button>
                  </Link>
                  <Link href="/about">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              <div className="group relative flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md hover:border-primary/50 transition-all dark:border-slate-700 dark:bg-[#1a2636]">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                    Enterprise-grade AES-256 encryption and full regulatory compliance ensure
              ...
              <div className="group relative flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md hover:border-primary/50 transition-all dark:border-slate-700 dark:bg-[#1a2636]">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                    Get preliminary findings in seconds. Our optimized inference engine is designed
                    for high-volume clinical workflows.
                  </p>
                </div>
              </div>
              ...
              <div className="group relative flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md hover:border-primary/50 transition-all dark:border-slate-700 dark:bg-[#1a2636]">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                    Validated against extensive, diverse datasets to minimize false positives and
          ...
          <div className="mx-auto w-full max-w-7xl overflow-hidden rounded-3xl bg-linear-to-br from-[#1a2636] to-background-dark border border-slate-700 relative">
            ...
            <div className="relative flex flex-col items-center justify-center gap-6 p-10 text-center md:p-20">
              ...
              <p className="max-w-xl text-lg text-slate-300">
                Join thousands of radiologists using PneumoScan Analyze to enhance precision and
                speed.
              </p>
              <Link href="/signup">
