    ...
    <div className="relative hidden md:flex md:w-1/2 bg-slate-900 flex-col justify-end p-8 lg:p-12 overflow-hidden group">
      ...
      <div className="relative z-10 flex flex-col gap-4">
        <div className="w-12 h-12 rounded-lg bg-primary flex items-center justify-center shadow-lg shadow-primary/30 mb-2">
          <span className="material-symbols-outlined text-white text-[28px]">vital_signs</span>
        </div>
        <h1 className="text-3xl font-bold text-white leading-tight">Advanced AI Diagnostics</h1>
        <p className="text-slate-300 text-sm leading-relaxed max-w-md">
          Join over 5,000 medical professionals using our secure platform to process chest X-rays
          with 99.8% accuracy. Instant analysis, securely encrypted.
        </p>
